...
(async () => {
  try {
    ...
    const corsOptions = {
      origin: 'https://bikely.mooo.com', // Configura el origen permitido
      methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],
      allowedHeaders: ['Content-Type', 'Authorization'],
      credentials: true,
    };
    app.use(cors(corsOptions));
    app.options('*', cors(corsOptions)); // Maneja todas las solicitudes OPTIONS globalmente
    ...
    app.options('/company/location', cors(corsOptions)); // Maneja OPTIONS específicamente para esta ruta
